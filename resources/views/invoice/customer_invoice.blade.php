                      ...
                      <div class="card bg-none card-box">
                          <section class="nav-tabs p-2">
                              @if ((isset($company_payment_setting['is_stripe_enabled']) && $company_payment_setting['is_stripe_enabled'] == 'on') ||
                                    ...
                                    (isset($company_payment_setting['is_tamara_enabled']) && $company_payment_setting['is_tamara_enabled'] == 'on') )
                                  ...
                                  <ul class="nav nav-pills  mb-3" role="tablist">
                                      ...
                                      @endif
                                          ...
                                          @if(isset($company_payment_setting['is_tamara_enabled']) && $company_payment_setting['is_tamara_enabled'] == 'on')
                                              <li class="nav-item mb-2">
                                                  <a class="btn btn-outline-primary btn-sm ml-1" data-bs-toggle="tab" href="#tamara-payment" role="tab" aria-controls="tamara" aria-selected="false">{{ __('Tamara') }}</a>
                                              </li>
                                          @endif
                              ...
                              <div class="tab-content">
                                  ...
                                  @endif
                                      ...
                                      @if(isset($company_payment_setting['is_tamara_enabled']) && $company_payment_setting['is_tamara_enabled'] == 'on')
                                      <div class="tab-pane fade " id="tamara-payment" role="tabpanel" aria-labelledby="tamara-payment">
                                          <form role="form" action="{{ route('customer.pay.with.tamara') }}" method="post" class="require-validation" id="tamara-payment-form">
                                              @csrf
                                              <input type="hidden" name="invoice_id" value="{{\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)}}">
                                              <div class="form-group col-md-12">
                                                  <label for="amount">{{ __('Amount') }}</label>
                                              ...
                                              <div class="form-group mt-3">
                                                  <button class="btn btn-primary" name="submit"  id="pay_with_tamara" type="submit">{{ __('Make Payment') }}</button>
                                              </div>
                                          </form>
                                      </div>
                                  @endif
