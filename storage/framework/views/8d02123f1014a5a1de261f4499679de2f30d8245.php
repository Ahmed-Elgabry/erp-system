...
unset($__errorArgs, $__bag); ?>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php echo e(isset($company_payment_setting['is_tamara_enabled']) && $company_payment_setting['is_tamara_enabled'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </button>
                                                        </h2>
                                                                        ...
                                                                        <div class="input-edits">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text"
                                                                                        ...
                                                                                        id="tamara_api_code"
                                                                                        class="form-control"
                                                                                        value="<?php echo e(!isset($company_payment_setting['tamara_api_code']) || is_null($company_payment_setting['tamara_api_code']) ? '' : $company_payment_setting['tamara_api_code']); ?>"
                    ...
                    <div id="sms-settings" class="card">
                        ...
                        <div class="card-body">
                            <?php echo e(Form::model($settings,['route'=>'company.sms.settings.notification', 'method'=>'POST'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ahmed\Desktop\codecanyon-VpChRk7J-erpgo-saas-all-in-one-business-erp-with-project-account-hrm-crm-pos (1)\main_file\resources\views/settings/company.blade.php ENDPATH**/ ?>