...
use App\Http\Controllers\TamaraPaymentController;
...
Route::post('/otp-verify', [EmailVerificationNotificationController::class, 'verify'])
    ->name('verify-otp');
...
Route::post('/customer-pay-with-tamara', [TamaraPaymentController::class,'payment'])->name('customer.pay.with.tamara');
Route::get('/customer/tamara/{invoice}/{amount}', [TamaraPaymentController::class,'getInvoicePaymentStatus'])->name('customer.toyyibpay');

// sms setting
Route::post('/setting/sms', [SmsSettingController::class,'saveSmsSetting'])->name('admin.sms.settings');
Route::post('/setting/sms/notification', [SmsSettingController::class,'saveSmsSettingNotification'])->name('company.sms.settings.notification');
