...
//     dd($request->all());
        ...
        if (isset($request->is_tamara_enabled) && $request->is_tamara_enabled == 'on') {

            $request->validate(
                [
                    'tamara_api_code' => 'required|string',
                ]
            );
            $post['is_tamara_enabled'] = $request->is_tamara_enabled;
            $post['tamara_api_code'] = $request->tamara_api_code;
        } else {
            $post['is_tamara_enabled'] = 'off';
        }
